...
export const meta = {
  ...
  date: '2018-10-01',
  description: 'A guide to using the new React Context API',
...
![](/works/discord-tutorial/devmode.png)

1. サーバーアイコン上で右クリックして、「ID をコピー」を選択します。サーバー ID がクリップボードにコピーされます。

![](/works/discord-tutorial/copy_server_id.png')
