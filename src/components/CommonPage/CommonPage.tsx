...
import SidebarProvider, { SidebarContext } from '~/providers/sidebar'
      ...
      <>
        ...
        {!mq.lg && (
          <button
            ...
            onClick={() => {
              console.log(sidebarContext.isOpened)
              sidebarContext.isOpened = !sidebarContext.isOpened}}
          >
            {'<'}
          </button>
        )}
        <Sidebar isOpened={sidebarContext.isOpened} />
      </>
    </SidebarProvider>
  )
}
