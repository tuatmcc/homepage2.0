  ...
  return (
    <>
      ...
      <div
        ...
        style={{ top: vH * 0.9, opacity: opacities[1] }}
      />
      <h2
        className={styles.name2}
        style={{ top: vH * 1.1, opacity: opacities[2] }}
      >
        私たちは、東京農工大学
        <br />
        マイクロコンピュータークラブ
      ...
      <p
        ...
        style={{ top: vH * 1.5, opacity: opacities[3] }}
      >
        Infomation
      </p>
      ...
      <p
        ...
        style={{ top: vH * 2.5, opacity: opacities[5] }}
      >
        Technology
      </p>
      <p
        className={styles.catchCopy}
        style={{ top: vH * 1.8, opacity: opacities[6] }}
      >
      ...
      <div
        className={styles.bottms}
        style={{ top: vH * 2.6, height: vH * (3 - 2.5) }}
      >
        <RecentNews />
      </div>
    </>
